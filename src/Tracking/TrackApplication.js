...
import NotFoundRed from "../assets/not-found-red.png";
import TrackList from "./TrackList";
import {useFetch} from "../API";

const api = useFetch('track');


function TrackNormal(props) {
    return (<div className="jumbotron">
            ...
            <div className="col-12 d-flex justify-content-center ">
                <div className="img-save d-flex justify-content-center ">
                    <img src={NotFound} className="status-img mt-auto mb-auto" alt="not found"/>
                </div>
            </div>
            <div className="col-12 text-center">
                <label className="label-check">Use track button to follow your iran visa application
                    status.</label>
            </div>
        </div>
    );
    ...
    return (
        <div className="jumbotron">
            ...
            <div className="col-12 d-flex justify-content-center ">
                <div className="img-save d-flex justify-content-center ">
                    <blockquote>
                        <img src={NotFoundRed} className="status-img" alt="not found"/>
                        <label className="text-center label-img">Application<br/> Not Found</label>
                    </blockquote>
                </div>
            </div>
            <div className="col-12 text-left">
                <label className="label-check">Please be ensure that you entered your tracking code
                    correctly.</label>
                <br/>
                <label className="label-check">If you haven’t fill iran visa application form,<a href="/"
                                                                                                 className="text-decoration-none">Click
                    here.</a></label>
                <br/>
                <label className="label-check">If you forgot your tracking code, login to your account by <a
                    href="/" className="text-decoration-none">clicking
                    here.</a></label>
                <br/>
                <label className="label-check">Please don’t hesitate to<a href="/"
                                                                          className="text-decoration-none"> Contact
                    us</a> if any trouble you are
                    facing.</label>
            </div>
        </div>
    );
...
function TrackFollow(props) {
    console.log(props.state);
    switch (props.state) {
        case "false":
            return (<TrackNotFound/>);
        case "success":
            return (<TrackList items={props.travelers}/>);
        default:
            return (<TrackNormal/>)
    }
}
...
class TrackApplication extends Component {
    constructor(props) {
        super(props);
        this.state = {
            trackCode: props.match.params.code ? props.match.params.code : '',
            trackState: 'normal',
            travelers: [],
            loader: true,
        };
    ...
    componentDidMount() {
        ...
        if (trackCode) {
            api.post({code: trackCode}).then((data) => {
                this.setState({travelers: data, loader: false, trackState: 'success'})
            }).catch(error => {
                if (error.code == 1009)
                    this.setState({travelers: [], loader: false, trackState: 'false'});
                else
                    alert(error.message);
            });
        } else
    ...
    getTrack(event) {
        const {trackCode} = this.state;
        this.props.history.push('/track/' + trackCode);
        if (trackCode) {
            api.post({code: trackCode}).then((data) => {
                this.setState({travelers: data, loader: false, trackState: 'success'})
            }).catch(error => {
    ...
    onChangeTrack(event) {
        this.setState({trackCode: event.target.value});
    }

    render() {
        const {trackState, loader, travelers, trackCode} = this.state;
        ...
        return (
            <div>
                ...
                <div className="offset">
                    {loader ?
                        <div>Loading...</div> :
                        <TrackFollow state={trackState} travelers={travelers}/>
                    }
                </div>
                    ...
                    <div className="jumbotron2">
                                ...
                                <div className="col mx-1">
                                    <div className="feature">
                                        <blockquote>
                                            ...
                                            <label className="text-center visa-label2">Receive Reference
                                                Number</label>
                                        </blockquote>
                        ...
                        <div className="col-12 float-left">
                            ...
                            <div className="col-10 float-left">
                                <label className="float-left label-desc">1- Filling Iran Visa Application
                                    Form</label>
                                <label className="float-left label-desc2">Lorem ipsum dolor sit amet, consectetur
                                    ...
                                    lacus vel facilisisLorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                    do
                                    ...
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
                                    gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. . </label>
                            ...
                            <div className="col-12 float-left">
                                ...
                                <div className="col-10 float-left">
                                    ...
                                    <label className="float-left label-desc2">Lorem ipsum dolor sit amet,
                                        consectetur
                                        adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                        aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra
                                        maecenas
                                        accumsan lacus vel facilisisLorem ipsum dolor sit amet, consectetur
                                        adipiscing
                            ...
                            <div className="col-12 float-left">
                                ...
                                <div className="col-10 float-left">
                                    <label className="float-left label-desc">3- Check Documents By
                                        VisaToIran</label>
                                    <label className="float-left label-desc2">Lorem ipsum dolor sit amet,
                                        consectetur
                                        adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                            ...
                            <div className="col-12 float-left">
                                ...
                                <div className="col-10 float-left">
                                    <label className="float-left label-desc">4- Sent To MFA (Ministry Of Foreign
                                        Affair)
                                        Visa Section</label>
                                    <label className="float-left label-desc2">Lorem ipsum dolor sit amet,
                                        consectetur
                            ...
                            <div className="col-12 float-left">
                                <img src={Qualification} className="float-left col-2  img-desc"
                                     alt="Qualification"/>
                                <div className="col-10 float-left">
                                ...
                                <div className="card">
                                    ...
                                    <div id="collapseOne" className="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div className="card-body">
                                            ...
                                            facilisisLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                            eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum
