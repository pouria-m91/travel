                    ...
                    <div className="container col-12">
                        <div className="row ">
                            ...
                            <div className="col-md-6">
                                <img className="img-fluid" src={HeadPic} alt="citizen"/>
                            </div>
                ...
                <div className="jumbotron">
                    ...
                    <div className="row">
                        ...
                        <div className="col-8 ml-4">
                            <h3 className="heading">Iran Visa for USA Citizens</h3>
                        </div>

                        <div className="col-8 float-left ml-4">
                            <label className="label-desc mb-5">
                            ...
                            <h3 className="heading mt-3 mb-3"> umsan lacus vel facilisis.</h3>

                            <label className="label-desc mb-5">
                                t amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                dolore magna
                                aliqua.
                            ...
                            <div className="card col-12 p-3 sticky-top card-width" id="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <button type="button" className="btn btn-outline-success mt-3 text-uppercase">
                                            APPLY NOW
                                        </button>
                                    </div>
                                </div>
...
export default VisaCountryInformation;